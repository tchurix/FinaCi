...
class PHPMailer
{
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img phpMailer.php="/images/a.png"> and must not be empty
    ...
    {
        preg_match_all('/(phpMailer.php|background)=["\'](.*)["\']/Ui', $message, $images);
